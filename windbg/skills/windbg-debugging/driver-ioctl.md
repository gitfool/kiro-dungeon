...
[`docs/driver-ioctl-walkthrough.md`](https://github.com/glslang/windbg-mcp/blob/main/docs/driver-ioctl-walkthrough.md) (Mount Point Manager —
the four reachability gates on a built-in driver) and
[`docs/hevd-ioctl-walkthrough.md`](https://github.com/glslang/windbg-mcp/blob/main/docs/hevd-ioctl-walkthrough.md) (HEVD — a *service-loaded*
